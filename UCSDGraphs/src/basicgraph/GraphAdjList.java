...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 List<Integer> inNeighbors = new ArrayList<Integer>();
		 List<Integer> inInNeighbors = new ArrayList<Integer>();
		 inNeighbors = getNeighbors(v);
		 for(int u : inNeighbors)
		 {
			 inInNeighbors.addAll(getNeighbors(u));
		 }
		 return inInNeighbors;
	}
